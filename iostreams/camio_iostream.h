...
struct camio_iostream{
     int(*open)(camio_iostream_t* this, const camio_descr_t* desc );             //Open the stream and prepare for reading/writing, return 0 if it succeeds
     ...
     camio_selectable_t rselector;                                               //Allows the read endpoint to be selected on

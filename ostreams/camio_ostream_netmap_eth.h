...
camio_ostream_t* camio_ostream_netmap_eth_new( const camio_descr_t* opts, camio_clock_t* clock, camio_ostream_netmap_eth_params_t* params, camio_perf_t* perf_mon);

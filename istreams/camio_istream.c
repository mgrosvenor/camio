...
camio_istream_t* camio_istream_new(const char* description, camio_clock_t* clock, void* parameters){
    ...
    if(strcmp(descr.protocol,"log") == 0 ){
        result = camio_istream_log_new(&descr,clock,parameters);
    }
    else if(strcmp(descr.protocol,"std-log") == 0 ){
        camio_istream_log_params_t params = { .fd = STDIN_FILENO};
        result = camio_istream_log_new(&descr,clock, &params);
    }
    else if(strcmp(descr.protocol,"raw") == 0 ){
        result = camio_istream_raw_new(&descr,clock,parameters);
    }
    else if(strcmp(descr.protocol,"ring") == 0 ){
        result = camio_istream_ring_new(&descr,clock,parameters);
    }
    else if(strcmp(descr.protocol,"udp") == 0 ){
        result = camio_istream_udp_new(&descr,clock,parameters);
    }
    else if(strcmp(descr.protocol,"periodic") == 0 ){
        result = camio_istream_periodic_timeout_new(&descr,clock,parameters);
    }
    else if(strcmp(descr.protocol,"period_fast") == 0 ){
        result = camio_istream_periodic_timeout_fast_new(&descr,clock,parameters);
    }
    else if(strcmp(descr.protocol,"blob") == 0 ){
        result = camio_istream_blob_new(&descr,clock,parameters);
    }
...
//#ifdef HAVE_DAG_
        ...
        result = camio_istream_dag_new(&descr,clock,parameters);
    }
    else if(strcmp(descr.protocol,"nmap") == 0 ){
        result = camio_istream_netmap_new(&descr,clock,parameters);
    }
